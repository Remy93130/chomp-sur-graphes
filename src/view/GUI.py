...
class GUI:
	...
	def drawRandomCrea(self,maxNodes,minArrows,maxArrows):
		...
		self.canvas.create_text(self.width*0.496,self.height*0.223,text="Nombre de sommet souhaité:",font=describeFont,tag="maxNodes")
		self.canvas.create_text(self.width*0.496,self.height*0.310,text="Nombre de liaison minimum par sommet:",font=describeFont,tag="minArr")
		self.canvas.create_text(self.width*0.496,self.height*0.397,text="Nombre de liaison maximum par sommet:",font=describeFont,tag="maxArr")
